...
9. **POC Simulation**: For the development and testing of the motor failure detection and control system in PX4, a comprehensive simulation environment was established. The setup used Ubuntu 20.04 LTS as the operating system and PX4 v1.13.x (or higher) as the autopilot system, integrated with Gazebo 11 for realistic simulation of vehicle dynamics and failure scenarios. ROS 1 (Noetic) was employed to facilitate communication between the PX4 autopilot and external systems, utilizing MAVLink and MAVROS for seamless data exchange. 
---
...
- #### Copy the Motor Failure Detection Module
    ...
    1. Unzip the provided module folder.
  2. Copy the entire module folder to the `PX4-Autopilot/src/modules` directory:
